...
bivariate, multi-variate, cholesky decomp of covar (relate to lin alg), relation to binomial tree
...
memoryless property application, relation to geometric, hyperexponential (releate to simulation)
...
sum of indep std normals, relation to gamma distrbution
